...
```{r}
hobbit_df <- data.frame(hobbit_text) %>% 
...
ggplot(data = afinn_means, 
       aes(x = fct_reorder(chapter, mean_afinn), 
           y = mean_afinn)) +
  geom_col() +
  coord_flip()
```

...and you can check out how this compares if you instead join to the bing or nrc lexicons! 
